...
const AdCommercialization: React.FC = () => {
  const cards = [
    {
      title: '新手入局',
      desc: '广告基础知识和黑话翻译',
  ...
  return (
    <div className="py-24 px-6 bg-zinc-50">
      <div className="max-w-6xl mx-auto text-center mb-16">
        <h2 className="text-4xl font-bold mb-4 tracking-tight">广告商业化</h2>
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8">
        {cards.map((card, idx) => (
          <div 
            key={idx} 
            className="group flex flex-col p-10 rounded-[2.5rem] bg-white border border-zinc-100 hover:border-purple-200 transition-all duration-500 hover:shadow-xl hover:-translate-y-1"
          >
...
export default AdCommercialization;
